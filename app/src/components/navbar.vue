        ...
        <!-- <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div class="flex space-x-4">
                        <button v-for="(btn, key) in buttons" :key="key"
                            ...
                            :class="`cursor-pointer px-3 py-2 text-md font-bold text-black uppercase
                                     ${btn == displayPage ? 'border-b-3 border-blue-400' : 'hover:border-blue-400 hover:border-b-3 hover:text-blue-800'}
                                    `">
                            {{ btn }}
                        </button>
                    </div>
